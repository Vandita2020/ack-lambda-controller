...
const (
	finalizerString = "finalizers.lambda.services.k8s.aws/FunctionEventInvokeConfig"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("functioneventinvokeconfigs")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.FunctionEventInvokeConfig{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.FunctionEventInvokeConfig),
	}
}
