...
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=functioneventinvokeconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=functioneventinvokeconfigs/status,verbs=get;update;patch
